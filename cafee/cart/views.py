...
def addToCart(request, product_id):
    ...
    return redirect('view_cart') # redirect should be used for the function based view 
 # for the class based view we have to use the success_url 
 # inside class based view we have inbuilt/ internal function ' return redirect(success_url) ' so no need to write the return redirect() 
